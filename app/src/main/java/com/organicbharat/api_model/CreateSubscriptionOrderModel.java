...
public class CreateSubscriptionOrderModel {
    public static class CreateSubscriptionOrderReq extends BaseReq{
    ...
    public static class CreateSubscriptionOrderRes extends BaseRes {
    }
}
